/**
 * @file
 * Implementation of CSIA2 algorithm.
 */
#include "csia2.hpp"
...
namespace sstss
{
    ...
    void CSIA2::preprocess(uint32_t m, double a)
    {
    ...
    void CSIA2::query(uint32_t k, DocId const& qid, double const& a, ResultVec &results,
